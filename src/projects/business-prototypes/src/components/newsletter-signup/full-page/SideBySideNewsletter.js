        ...
        return (
            <div style={{ marginTop: '18px' }}>
                <div className="form-row" style={{backgroundColor: 'white'}}>
                    <div className="col-6" style={{ border: '1px solid black', paddingTop: '15%', paddingBottom: '14%', paddingLeft: '7%', paddingRight: '8%'}}>
                        ...
                        <input type="text" class="form-control-lg col-12" placeholder="Enter your email" />
                        <br />
                        <br />
